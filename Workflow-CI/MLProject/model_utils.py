"""
CATATAN SINKRONISASI: file ini adalah salinan dari Membangun_model/model_utils.py.
Disalin (bukan di-import) karena MLflow Project menjalankan folder ini secara
mandiri dengan conda env sendiri (lihat conda.yaml), tanpa akses ke folder lain
di repo. Jika mengubah logic di Membangun_model/model_utils.py, salin ulang
perubahannya ke sini juga.
"""
